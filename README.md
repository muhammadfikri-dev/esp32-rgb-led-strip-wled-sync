# ⚡ Kontroler Lampu LED Strip RGB WS2812B WLED Sync
...
Pengontrol strip lampu LED digital addressable WS2812B/NeoPixel dengan efek animasi dinamis, sinkronisasi UDP E1.31, dan antarmuka web modern.
...
1. Buka file **`esp32-rgb-led-strip-wled-sync.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
